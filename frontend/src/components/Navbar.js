    ...
    return (
        <nav className="bg-slate-200 border-gray-200 dark:bg-gray-900 dark:border-gray-700">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <img src="/images/DFS.png" className="h-8 mr-3" alt="DFS LOGO" />
                    
                    <p className="self-center text-xl font-semibold whitespace-wrap dark:text-white">Sleep EDF application for understanding sleep patterns and sleep disorders.</p>
                ...
                <div className="hidden w-full md:block md:w-auto" id="navbar-dropdown">
                    <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-slate-200 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white-slate-200 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
